...
public class LinkedListCRUD {
    public static void main(String[] args) {
        ...
        //删除节点
        System.out.println("删除 = " + linkedList.remove());//这里默认删除的是第一个节点
        //linkedList.remove(2);
        System.out.println("linkedList = " + linkedList);//[2, 3]

        //修改某个节点对象
        linkedList.set(1, 999);
        System.out.println("linkedList = " + linkedList);//[2, 999]
        ...
        //因为 LinkedList 是 实现了 List接口,遍历方式
